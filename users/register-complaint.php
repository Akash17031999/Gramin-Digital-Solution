...
$compvideo=$_FILES["compvideo"]["name"];

$maxsize = 50242880;
move_uploaded_file($_FILES["compfile"]["tmp_name"],"complaintdocs/".$_FILES["compfile"]["name"]);
if(($_FILES['compvideo']['size'] >= $maxsize) || ($_FILES["compvideo"]["size"] == 0)) {
move_uploaded_file($_FILES["compvideo"]["tmp_name"],"videos/".$_FILES["compvideo"]["name"]);
}
else
{
...
$query=mysqli_query($con,"insert into tblcomplaints(userId,category,subcategory,complaintType,state,noc,complaintDetails,complaintFile,complaintvideo) values('$uid','$category','$subcat','$complaintype','$state','$noc','$complaintdetials','$compfile','$compvideo')");
...
<div class="form-group">
  <label class="col-sm-2 col-sm-2 control-label">Village name</label>
  <div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Complaint Related Video(if any) </label>
<div class="col-sm-6">
<input type="file" name="compvideo" class="form-control" value="">
</div>
</div>
